<?php
$mysqli->query("CREATE DATABASE IF NOT EXISTS ".$cfg[database]."");
$mysqli->query("CREATE TABLE IF NOT EXISTS `dl_carrinho` (
  `ip` text NOT NULL,
...
$mysqli->query("CREATE TABLE IF NOT EXISTS `dl_categorias` (
  `nome` text NOT NULL,
  `id` int(4) NOT NULL auto_increment,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;");

$mysqli->query("CREATE TABLE IF NOT EXISTS `dl_pedidos` (
  `id` int(4) NOT NULL auto_increment,
  `valor` text NOT NULL,
  `data` text NOT NULL,
...
$mysqli->query("CREATE TABLE IF NOT EXISTS `dl_produtos` (
  `id` int(4) NOT NULL auto_increment,
  `nome` text NOT NULL,
  `descricao` text NOT NULL,
  `foto` text NOT NULL,
