...
<input type="text" name="tel" class="form-control" value="<?=$_SESSION[dv_tel];?>" maxlength="9" placeholder="Tel de contato, somente n&uacute;meros..." required /><br />
<input type="text" name="cep" id="cep" class="form-control" value="<?=$_SESSION[dv_cep];?>" maxlength="8" placeholder="CEP" required />
<input name="xd" type="text" id="xd" size="60" disabled="disabled" style="color:#006600;border:thin solid #eaeaea;background-color:#fff;" class="form-control" /><br>
...
$_SESSION[dv_cm] = $_POST[descricao];
